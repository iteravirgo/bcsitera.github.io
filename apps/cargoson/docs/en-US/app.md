...
[https://www.cargoson.com/](https://www.cargoson.com/).

### Key Features
* Send Transportation Orders (incl. Transportation Orders with Direct Booking option) from Business Central to Cargoson.
